...
import 'package:flutter_netease/base/base_get_view.dart';
...
class DiscoveryPage extends BaseGetView<DiscoveryPageController> {
  @override
  Widget buildContent() {
    return HideKeyboard(child: Scaffold(backgroundColor: Colours.app_main_background, body: obxWidget()));
  }

  @override
  Widget obxWidget() {
    return super.obxWidget();
  }
